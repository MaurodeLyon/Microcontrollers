...
int main()
{
	...
	spi_write(14);				// digit value: i (= digit place)
	spi_slaveDeSelect(0);		// Deselect display chip
	wait(1000);

	spi_slaveSelect(0);			// Select display chip
	spi_write(2);				// digit adress: (digit place)
	spi_write(13);				// digit value: i (= digit place)
	spi_slaveDeSelect(0);		// Deselect display chip
	wait(1000);

	spi_slaveSelect(0);			// Select display chip
	spi_write(3);				// digit adress: (digit place)
	spi_write(11);				// digit value: i (= digit place)
	spi_slaveDeSelect(0);		// Deselect display chip
	wait(1000);
	
	spi_slaveSelect(0);			// Select display chip
	spi_write(4);				// digit adress: (digit place)
	spi_write(12);				// digit value: i (= digit place)
	spi_slaveDeSelect(0);		// Deselect display chip
